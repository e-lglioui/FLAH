    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#16a34a] p-4 z-50 sidebar-menu transition-transform">
        ...
        <ul class="mt-4">
            ...
            <li class="mb-1 group">
                <a href="{{route("TodayRendez")}}" class="flex font-semibold items-center py-2 px-4 text-white hover:bg-gray-950 hover:text-white rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-withe-100 sidebar-dropdown-toggle">
                    <i class='bx bx-list-ul mr-3 text-lg'></i>               
                    <span class="text-sm  ">Rendez-vous </span>
                </a>
            </li>
            <li class="mb-1 group">
                <a href="{{route("Mesrendezvous")}}" class="flex font-semibold items-center py-2 px-4 text-white gi hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100">
